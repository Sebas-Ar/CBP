...
const SelectCategory = ({ updateCategoryName, updateSubcategoryName, updateSubcategoryList, updateCategoryList, updateItems, setActiveCategory }) => {
    ...
    return <div className="container">
        ...
        <div className="wrapper">
            ...
            <svg viewBox="0 0 640 512" onClick={() => setActiveCategory(true)}>
