                ...
                <div className="stars">
                    <svg viewBox="187.421 0 3276.909 560" className="star">
                        ...
                        <path
                            ...
                            className="cuatro"
                            d="M2467.424,19.469l-71.422,144.813l-159.797,23.297c-28.656,4.156-40.141,39.484-19.359,59.719l115.609,112.656  l-27.344,159.141c-4.922,28.766,25.375,50.313,50.75,36.859l142.953-75.141l142.953,75.141c25.375,13.344,55.672-8.094,50.75-36.859  l-27.344-159.141l115.609-112.656c20.781-20.234,9.297-55.563-19.359-59.719l-159.797-23.297l-71.422-144.813  C2517.408-6.343,2480.33-6.671,2467.424,19.469z"
                        />
                        <path
                            onClick={() => {
                                changeStart(3)
                            ...
                            className="tres"
                            d="M1794.486,19.469l-71.422,144.813l-159.797,23.297c-28.656,4.156-40.141,39.484-19.359,59.719l115.609,112.656  l-27.344,159.141c-4.922,28.766,25.375,50.313,50.75,36.859l142.953-75.141l142.953,75.141c25.375,13.344,55.672-8.094,50.75-36.859  l-27.344-159.141l115.609-112.656c20.781-20.234,9.297-55.563-19.359-59.719l-159.797-23.297l-71.422-144.813  C1844.471-6.343,1807.393-6.671,1794.486,19.469z"
                        />
                        <path
                            onClick={() => {
                                changeStart(2)
                            ...
                            className="dos"
                            d="M1121.548,19.469l-71.422,144.813l-159.797,23.297c-28.656,4.156-40.141,39.484-19.359,59.719l115.609,112.656  l-27.344,159.141c-4.922,28.766,25.375,50.313,50.75,36.859l142.953-75.141l142.953,75.141c25.375,13.344,55.672-8.094,50.75-36.859  l-27.344-159.141l115.609-112.656c20.781-20.234,9.297-55.563-19.359-59.719l-159.797-23.297l-71.422-144.813  C1171.532-6.343,1134.454-6.671,1121.548,19.469z"
                        />
                        <path
                            onClick={() => {
                                changeStart(1)
                ...
                <ul>
                    ...
                    {commentList.map((item, i) => (
                        <li>
                            <article key={i}>
                                <img
                                    src="https://www.shareicon.net/data/2016/11/14/852267_user_512x512.png"
                                    alt="iconon sin mostrar"
                                />
                                <div>
