    ...
    return (
        <li onClick={change} onKeyDown={change} role="presentation">
            ...
            <style jsx>
                {`
                    li {
                        color: ${title === itemSelected
                            ? '#F1D58C'
                            : '#A99767'};
                    }

                    li::before {
                        background: ${title === itemSelected
                            ? '#F1D58C'
                            : '#A99767'};
                    }
...
Item.propTypes = {
    ...
    updateItemSelected: PropTypes.func.isRequired,
    updateImgSelected: PropTypes.func.isRequired,
}
